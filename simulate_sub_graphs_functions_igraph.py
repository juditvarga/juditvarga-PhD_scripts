...
def confint_and_plot_sim_modularities(simulated_modularities_list, 
    ...
    if weigthed_detection == False:
        directory = 'P:/thesis/thesis_final_visualisations/simulated_journal_authorbibcouple/temporal/{}_{}_edgedecimal{}/'.format(cos_sim_for_filename, catf, round_number)
